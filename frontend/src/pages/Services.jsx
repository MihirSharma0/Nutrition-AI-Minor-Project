            ...
            <div className="max-w-7xl mx-auto px-8 w-full relative z-10">
                ...
                <div className="flex flex-col md:flex-row items-center gap-16 mb-32 group">
                    <div className="md:w-1/2 order-2 md:order-1">
                        ...
                        <h2 className="text-4xl md:text-5xl font-bold mb-6 tracking-tight leading-tight">Continuous Biometric Telemetry</h2>
                    ...
                    <div className="md:w-1/2 order-1 md:order-2 w-full">
                        <div className="bg-white/5 border border-white/10 rounded-[3rem] p-4 relative overflow-hidden h-[400px]">
                ...
                <div className="flex flex-col md:flex-row items-center gap-16 mb-32 group">
                    <div className="md:w-1/2 w-full">
                        <div className="bg-white/5 border border-white/10 rounded-[3rem] p-4 relative overflow-hidden h-[400px]">
                            ...
                            <div className="absolute inset-0 flex items-center justify-center">
                                <div className="w-64 h-64 border border-primary/30 rounded-full animate-[spin_30s_linear_infinite] flex items-center justify-center">
                                    <div className="w-48 h-48 border border-primary/20 rounded-full animate-[spin_20s_linear_infinite_reverse] flex items-center justify-center">
                                        <div className="w-32 h-32 bg-primary/20 blur-xl rounded-full animate-pulse"></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="md:w-1/2">
                        ...
                        <h2 className="text-4xl md:text-5xl font-bold mb-6 tracking-tight leading-tight">Generative Culinary Synthesis</h2>
                        <p className="text-white/60 text-lg leading-relaxed mb-8">
                ...
                <div className="flex flex-col md:flex-row items-center gap-16 group">
                    <div className="md:w-1/2 order-2 md:order-1">
                        ...
                        <h2 className="text-4xl md:text-5xl font-bold mb-6 tracking-tight leading-tight">Predictive Trajectory Modeling</h2>
                        <p className="text-white/60 text-lg leading-relaxed mb-8">
