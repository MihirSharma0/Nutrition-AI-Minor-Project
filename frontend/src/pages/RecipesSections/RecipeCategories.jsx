...
const RecipeCategories = () => {
    ...
    return (
        <section className="py-12 max-w-7xl mx-auto px-8 relative z-20 border-t border-white/5 mt-16">
            ...
            <div className="flex flex-wrap items-center justify-center gap-4">
                {categories.map((cat, idx) => (
                    <button 
                        ...
                        className={`flex items-center gap-2 px-6 py-3 rounded-full text-sm font-bold uppercase tracking-widest transition-all duration-300 ${active === cat.name ? 'bg-primary text-[#080b12] shadow-[0_0_20px_rgba(163,230,53,0.3)]' : 'bg-white/5 text-white/70 hover:bg-white/10 hover:text-white border border-white/10'}`}
                    >
