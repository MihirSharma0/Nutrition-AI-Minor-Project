    ...
    return (
        <section className="py-24 max-w-7xl mx-auto px-8 relative z-20">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 lg:gap-24">
                <div className="bg-white/5 border border-white/10 p-10 md:p-14 rounded-3xl hover:bg-white/10 transition-colors">
                    <span className="material-symbols-outlined text-primary text-5xl mb-6">flag</span>
                    <h2 className="font-hero-display text-4xl font-bold text-white mb-6">Our Mission</h2>
                ...
                <div className="bg-white/5 border border-white/10 p-10 md:p-14 rounded-3xl hover:bg-[#38bdf8]/10 hover:border-[#38bdf8]/30 transition-colors">
                    <span className="material-symbols-outlined text-[#38bdf8] text-5xl mb-6">visibility</span>
                    <h2 className="font-hero-display text-4xl font-bold text-white mb-6">Our Vision</h2>
                    <p className="text-white/70 text-lg leading-relaxed">
