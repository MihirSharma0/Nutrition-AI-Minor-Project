        ...
        <section className="py-24 max-w-7xl mx-auto px-8 relative z-20">
            <div className="bg-[#111827] border border-white/5 rounded-[3rem] overflow-hidden flex flex-col md:flex-row items-center">
                <div className="md:w-1/2 p-12 md:p-20">
                    ...
                    <h2 className="font-hero-display text-4xl md:text-5xl font-bold text-white mb-6">Why Personalized Nutrition Matters</h2>
                ...
                <div className="md:w-1/2 min-h-[400px] md:min-h-full w-full relative">
