    ...
    return (
        <section className="py-24 max-w-7xl mx-auto px-8 relative z-20">
            <div className="text-center mb-16">
                ...
                <h2 className="font-hero-display text-4xl md:text-5xl font-bold text-white mb-6">Featured Research</h2>
            </div>
            ...
            <div className="bg-white/5 border border-white/10 rounded-[3rem] overflow-hidden flex flex-col lg:flex-row hover:border-primary/50 transition-colors duration-500 group cursor-pointer">
                ...
                <div className="lg:w-1/2 p-12 md:p-16 flex flex-col justify-center relative bg-[#080b12]">
                    <div className="flex items-center gap-4 mb-6 text-sm font-bold uppercase tracking-wider text-white/50">
                        <span className="text-primary">Clinical Studies</span>
                        <span className="w-1 h-1 rounded-full bg-white/20"></span>
                        <span>8 Min Read</span>
                    </div>
                    <h3 className="text-3xl md:text-4xl font-bold text-white mb-6 leading-tight group-hover:text-primary transition-colors">
