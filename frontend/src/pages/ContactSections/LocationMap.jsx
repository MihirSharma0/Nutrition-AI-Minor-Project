    ...
    return (
        <section className="py-24 max-w-7xl mx-auto px-8 relative z-20">
            <div className="text-center mb-16">
                ...
                <h2 className="font-hero-display text-4xl md:text-5xl font-bold text-white mb-6">Global Clinics</h2>
            </div>
            ...
            <div className="bg-white/5 border border-white/10 rounded-[3rem] p-8 md:p-12 overflow-hidden relative">
                <div className="aspect-video w-full rounded-2xl overflow-hidden relative group border border-white/10">
                    ...
                    <div className="absolute bottom-8 left-8 right-8 flex flex-col md:flex-row justify-between items-end gap-6">
                        <div>
                            <h3 className="text-2xl font-bold text-white mb-2">New York HQ</h3>
                            <p className="text-white/60">One World Trade Center, Suite 4500<br/>New York, NY 10007</p>
                        </div>
                        <button className="bg-white/10 backdrop-blur-md border border-white/20 text-white px-6 py-3 rounded-full font-bold hover:bg-white hover:text-[#080b12] transition-colors flex items-center gap-2">
