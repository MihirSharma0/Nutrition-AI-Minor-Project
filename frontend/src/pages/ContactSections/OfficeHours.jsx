    ...
    return (
        <section className="py-12 max-w-7xl mx-auto px-4 sm:px-8 relative z-20">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8">
                <div className="bg-white/5 border border-white/10 rounded-[2.5rem] p-6 sm:p-10 flex flex-col items-center text-center">
                    ...
                    <ul className="w-full max-w-sm space-y-4">
                        <li className="flex flex-col sm:flex-row justify-between sm:items-center gap-1 sm:gap-0 text-white/70 border-b border-white/5 pb-2">
                        ...
                        <li className="flex flex-col sm:flex-row justify-between sm:items-center gap-1 sm:gap-0 text-white/70">
                            <span>Sunday</span>
                ...
                <div className="bg-gradient-to-br from-[#38bdf8]/10 to-transparent border border-white/10 rounded-[2.5rem] p-6 sm:p-10 flex flex-col items-center text-center justify-center relative overflow-hidden">
