...
const FAQLink = () => {
    return (
        <section className="py-12 max-w-4xl mx-auto px-8 relative z-20">
            <div className="bg-gradient-to-r from-transparent via-white/5 to-transparent border-y border-white/10 py-12 text-center">
                <span className="material-symbols-outlined text-4xl text-primary mb-4">help</span>
                <h3 className="text-2xl font-bold text-white mb-2">Have a quick question?</h3>
