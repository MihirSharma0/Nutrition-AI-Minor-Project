    ...
    return (
        <div className="w-full">
            ...
            <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-[2.5rem] overflow-hidden shadow-2xl">
                ...
                {/* Calendar Header */}
                <div className="p-6 border-b border-white/10 flex justify-between items-center bg-[#080b12]/80">
                    <div className="flex items-center gap-4">
                        ...
                        <h2 className="text-xl font-bold font-hero-display">October 2026</h2>
                        <button className="w-8 h-8 rounded-full border border-white/10 flex items-center justify-center hover:bg-white/10 transition-colors">
