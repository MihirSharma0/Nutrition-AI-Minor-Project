            ...
            <div className="bg-white border border-outline-variant/30 shadow-2xl rounded-[3rem] overflow-hidden">
                <div className="grid grid-cols-1 lg:grid-cols-2">
                    ...
                    <div className="relative min-h-[400px] lg:min-h-full">
                        ...
                        <div className="absolute bottom-10 right-10 bg-white/80 backdrop-blur-md border border-outline-variant/30 shadow-xl p-6 rounded-2xl flex items-center gap-6">
                            <div>
                                <div className="text-on-background/50 text-xs font-bold tracking-wider uppercase mb-1">Success Rate</div>
                                <div className="text-3xl font-black text-on-background">94.2%</div>
                            </div>
                            <div className="w-px h-10 bg-outline-variant/30"></div>
                            <div>
                                <div className="text-on-background/50 text-xs font-bold tracking-wider uppercase mb-1">Avg. Time</div>
                                <div className="text-3xl font-black text-primary">12 Wks</div>
                            </div>
                        </div>
                    </div>
                </div>
