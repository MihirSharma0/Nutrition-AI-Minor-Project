            ...
            <div className="max-w-7xl mx-auto px-8 w-full relative z-10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    {reviews.map((review, index) => (
                        <div 
                            key={index} 
                            className="bg-white/5 backdrop-blur-xl border border-white/5 rounded-[2.5rem] p-10 transition-all duration-500 hover:-translate-y-2 hover:border-white/20 hover:shadow-[0_20px_40px_-15px_rgba(255,255,255,0.07)] group cursor-pointer"
                        >
                ...
                <div className="mt-32 bg-gradient-to-r from-primary/10 to-[#38bdf8]/10 border border-white/10 rounded-[3rem] p-16 text-center relative overflow-hidden group">
                    ...
                    <div className="relative z-10">
                        <h2 className="text-4xl md:text-5xl font-bold tracking-tight mb-8">Ready to optimize your biology?</h2>
